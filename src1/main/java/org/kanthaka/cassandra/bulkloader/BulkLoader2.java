...
public class BulkLoader2 {
		...
		{
				String[] s = {"/home/pushpalanka/Installations/FYP/Kanthaka/CDRs"};
				args = s;
				LoaderOptions options = LoaderOptions.parseArgs(args);
//        System.setProperty("storage-config","/home/amila/CassendrA/apache-cassandra-1.1.1/cassandra.yaml");
				try {
		...
		static class ExternalClient extends SSTableLoader.Client {
				...
				public void init(String keyspace) {
						...
						outputHandler.output(String.format("Starting client (and waiting %d seconds for gossip) ...",
...
//   	        }
								...
								try {
										for(TokenRange tr : tokenRanges){
												Range range = new Range(tkFactory.fromString(tr.start_token),
		...
		static class LoaderOptions implements SSTableLoader.OutputHandler {
				...
				private static CmdLineOptions getCmdLineOptions() {
						...
						options.addOption("i", IGNORE_NODES_OPTION, "NODES", "don't stream to this (comma separated) list of " +
								"nodes");
						return options;
				}
