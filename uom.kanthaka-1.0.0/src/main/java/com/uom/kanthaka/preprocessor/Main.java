...
import com.uom.kanthaka.cassandra.ruleexecuter.QueryRunUtill;
import com.uom.kanthaka.cassandra.ruleexecuter.QueryRunner;
import com.uom.kanthaka.preprocessor.cdrreader.CdrMapUpdater;
...
public class Main {
    ...
    public static void main(String args[]) throws InterruptedException {
        ...
        mapUpdatingTimer.schedule(mapUpdater, 1000, 2000); // Create Repetitively task for every 1 secs
