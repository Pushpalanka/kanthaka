...
/**
     ...
     * @param
     */
    public HashSet<String> compareResultSet(Rule businessRule,QueryRunUtill queryRunner) {
        ...
        if(!outerCondition.isEmpty()){
            System.out.println("this is the final set of "+businessRule.getRuleName()+":"+outerCondition);
