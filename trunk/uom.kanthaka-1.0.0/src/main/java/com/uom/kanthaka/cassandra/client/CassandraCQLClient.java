...
public class CassandraCQLClient {
	...
	public static void main(String[] args) {
		...
		CqlQuery<String, String, Long> cqlQuery = new CqlQuery<String, String, Long>(
				HFactory.createKeyspace(BasicConf.KEYSPACE, cluster), se, se,LongSerializer.get());
...
//					}else
	...
	void Hcl(){
		...
		CounterQuery<String, String> query = HFactory.createCounterColumnQuery(keyspace, se,se);
