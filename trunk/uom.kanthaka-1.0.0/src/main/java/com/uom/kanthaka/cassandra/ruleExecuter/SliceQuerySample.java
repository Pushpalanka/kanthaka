...
public class SliceQuerySample {
    ...
    public void createKeyspace() {
        ...
        KeyspaceDefinition newKeyspaceDef = HFactory.createKeyspaceDefinition(KEYSPACE);
    ...
    private void dataInserter(String ruleName, String columnName, ConcurrentHashMap<String, Long> entries) {
        ...
        for (String s : keys) {
            ...
            mutator = mutator
                    .addInsertion(rowKey, ruleName,HFactory.createColumn(columnName, newValue, StringSerializer.get(), LongSerializer.get()))
                    .addInsertion(rowKey,ruleName,HFactory.createColumn("flag",1L,se,le))
                    .addInsertion(rowKey, ruleName, HFactory.createColumn("phoneNumber", phone, se, le));
